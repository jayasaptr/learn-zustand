...
const Home = () => {
    ...
    return (
        <div className="relative">
            ...
            {/* Backgroud */}
            <div className="relative w-full lg:h-[600px] h-[400px] bg-right bg-no-repeat bg-[length:800px_600px]" style={{ backgroundImage: `url(${quranBg})` }}>
                <div className="absolute inset-0 bg-cyan-500 opacity-75"></div>
                <svg className="absolute bottom-0 w-full rotate-180" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#fff" fill-opacity="1" d="M0,224L80,224C160,224,320,224,480,208C640,192,800,160,960,154.7C1120,149,1280,171,1360,181.3L1440,192L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
            </div>
            ...
            <div className="absolute inset-0">
                <div className="flex flex-col items-center mx-auto py-6">
                    ...
                    <div className="flex flex-row gap-2 md:justify-center justify-between w-full px-8 items-center h-full  mt-6">
                        <TypeSelector />
                        <Button className="bg-transparent border-white shadow-none border hover:bg-transparent"><DescIcon /></Button>
                    </div>

                    <div className="mt-7 max-w-full mx-auto w-full grid grid-cols-1 gap-3 px-8  md:grid-cols-2 lg:grid-cols-3">
                        <BoxSurah />
                        <BoxSurah />
                        <BoxSurah />
                        <BoxSurah />
